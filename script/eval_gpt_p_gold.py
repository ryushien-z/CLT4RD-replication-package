...
def run_evaluation(refactoring_type: str):
    output_results_path = f"../results/gpt4.1mini/gold/gold_python_{refactoring_type.replace(' ', '_').lower()}.json" # Define output path here
    ...
    fewshot_examples = load_fewshot_examples('python', refactoring_type, 2)

    fewshot_block = f"Here are some code change examples\n"
